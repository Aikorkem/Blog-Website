...
const Post = mongoose.model("Post", {name: String, text: String});
...
app.get("/posts/:postId", function(req,res){
  ...
  Post.findOne({_id: reqPostID},function(error, results){
    if(error){
      console.log(error);
    }else{
      res.render("post", {
  ...
  // posts.forEach(post => {
  //   const lowerD = _.lowerCase(post.title);
  //   if(postName === lowerD){
  //     // Going to the post asked
  //     res.render("post", {
  //       title: post.title, 
  //       text: post.text
  //     });
